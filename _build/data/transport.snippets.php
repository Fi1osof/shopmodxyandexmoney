...
$snippet->fromArray(array(
    'name' => 'yandexmoney.getButton',
    'description' => 'Получаем кнопку для оплаты',
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/yandexmoney.getButton.php'),
    'properties'    => $params,
),'',true,true);
$snippets[] = $snippet;


// yandexmoney.payResult
$snippet= $modx->newObject('modSnippet');
$snippet->fromArray(array(
    'name' => 'yandexmoney.payResult',
    'description' => 'Проверка результата оплаты',
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/yandexmoney.payResult.php'),
),'',true,true);
$snippets[] = $snippet;
